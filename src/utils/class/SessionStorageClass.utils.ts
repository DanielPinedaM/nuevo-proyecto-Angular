...
export default class Storage {
  ...
  listAll = (): ISessionStorageObject | null => {
  ...
  properties = (): string[] | null => {
    const listAll: ISessionStorageObject | null = this.listAll();
...
"cuando NO existe lo creo" */
  save = (
    ...
    const search: boolean = this.search(property);
  ...
  deleteExcept = (properties: string[]): boolean => {
    ...
    const sessionStorageKeys: string[] = this.properties()!;
